...
<body>
  ...
  <a id="button" href="survey_for_test1.php" id="btn">Answer questions</a>
...
<?php
    $sql = 'SELECT * FROM survey_for_1 ORDER BY id DESC LIMIT 1';
...
<div id="card" class="card" style="width: 18rem;">
  <div class="card-body">
    ...
    <h6 class="card-subtitle mb-2 text-muted">Favorite Musician: <?php echo $row['fav_mus']?></h6>
    <h6 class="card-subtitle mb-2 text-muted">Favorite Color: <?php echo $row['fav_col']?></h6>
